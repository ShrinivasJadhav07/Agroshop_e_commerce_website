...
from .models import Cart,Customer, Payment, Product,OrderPlaced
...
class checkout(views.View):
    def get(self, request):
       ...
       # {'id': 'order_LbdGtwi0XGzLOv', 'entity': 'order', 'amount': 140, 'amount_paid': 0, 'amount_due': 140, 'currency': 'INR', 'receipt': 'order_rcptid_12', 'offer_id': None, 'status': 'created', 'attempts': 0, 'notes': [], 'created_at': 1681030104}
